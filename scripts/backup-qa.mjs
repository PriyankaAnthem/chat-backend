// // scripts/upsert-qa.mjs
// // Run with: node scripts/upsert-qa.mjs
...
//   // 👇 Path to your JSON file — change this to wherever your file is
//   const filePath = resolve("anthem_qa_holidays.json");
...
//     // Use embedding_text if available, fallback to question
